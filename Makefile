...
grpc: mod-down
	protoc -I=internal/rpc/proto -I=$(GOPATH)/pkg/mod/github.com/grpc-ecosystem/grpc-gateway@v1.16.0/third_party/googleapis --go_out=internal/rpc --go-grpc_out=internal/rpc internal/rpc/proto/*.proto
mod-tidy:
	go mod tidy
mod-down:
	go mod download
